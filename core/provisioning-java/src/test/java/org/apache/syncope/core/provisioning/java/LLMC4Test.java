...
public class LLMC4Test {
    ...
    void setUp() throws Exception {
        ...
        // Risolve la chiamata interna getSelf() mockando il contesto Spring[cite: 13]
    ...
    private static IntAttrName parsed(final String name) {
        ...
        // Include le nuove stringhe "uManager" e "gManager" per simulare il parser in base alle nuove logiche di costante[cite: 13]
    ...
    void publicAndProtectedMethodsStillExposeExpectedMappingApi() {
        ...
        // Verifica la preservazione dell'API inclusa l'introduzione/modifica di scope dei metodi[cite: 13]
    ...
    void processPreparedAttrAddsAttributeAndReturnsConnObjectKey() {
        ...
        // Test sul metodo che ora è stabilmente public static[cite: 13]
    ...
    void setIntValuesSetsManagerFields() throws Exception {
        ...
        // Testa lo switch sulle nuove constanti come U_MANAGER definite nella logica di setIntValues[cite: 13]
