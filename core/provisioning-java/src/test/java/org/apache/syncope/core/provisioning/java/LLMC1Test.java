...
public class LLMC1Test {
    ...
    void setUp() throws Exception {
        ...
        // Risolve il getSelf() introdotto nella classe target fornendo un mock del contesto Spring
    ...
    private static IntAttrName parsed(final String name) {
        ...
        if ("username".equals(name) || "name".equals(name) || "mustChangePassword".equals(name) || "password".equals(name)) {
    ...
    void processPreparedAttrAddsAttributeAndReturnsConnObjectKey() {
        ...
        Optional<String> result = DefaultMappingManager.processPreparedAttr(new MappingManager.PreparedAttr("jsmith", attr), attributes);
    ...
    void processPreparedAttrToleratesNullAttribute() {
        ...
        Optional<String> result = DefaultMappingManager.processPreparedAttr(new MappingManager.PreparedAttr(null, null), attributes);
